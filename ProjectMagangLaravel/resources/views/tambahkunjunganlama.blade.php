...
@section("kunjungan")
    ...
    @endif
        ...
        <form action="/save-kunjungan-lama" method="post">
            @csrf
            <div class="row">
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="Id_RekamMedis" id="noRekamMedis" class="form-control" readonly required>
                    ...
                    <table class="table table-striped table-bordered" id="tabelPasien">
                        ...
                        <tbody id="pasienTableBody">
                            ...
                            <tr>
                                ...
                                <td>{{ $pasien['kecamatan'] ?? 'N/A' }}</td>
                                <td>{{ $pasien['kabupaten'] ?? 'N/A' }}</td>
                                <td>{{ $pasien['provinsi'] ?? 'N/A' }}</td>
                                <td>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setupSearch('searchPasien', 'tabelPasien', [1]);
    setupSearch('searchAlamat', 'tabelPasien', [4]);
    setupSearch('searchKecamatan', 'tabelPasien', [5]);
    ...
    $(document).on('click', '.pilih-pasien', function() {
        ...
        $('#kabupaten').val($(this).data('kabupaten'));
